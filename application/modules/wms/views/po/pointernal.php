...
<input type="hidden" name="po" value="<?php echo $kode?>">
    ...
    <input type="button" value="Select" class="btn btn-info" id="pointernal"/><i class=""></i>
  </span>
  ...
  <div class="col-md-6 col-sm-12 col-xs-12 form-group">
    <input type="text" class="form-control" name="vendor" placeholder="WH" required="TRUE">
  </div>
  <div class="col-md-6 col-sm-12 col-xs-12 form-group">
    <input type="text" class="form-control" name="lokasi" placeholder="Location" required="TRUE">
  </div>
